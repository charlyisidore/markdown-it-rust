...
//! markdown_it::plugins::extra::footnote::inline::add(parser);
...
//! "markdown_it::plugins::extra::footnote::inline::InlineFootnote",
    ...
    fn run(state: &mut InlineState) -> Option<(Node, usize)> {
        ...
        match parse_footnote(state, content_start) {
            Some(content_end) => {
                ...
                let ref_node = Node::new(super::references::FootnoteReference {
                    label: None,
                    ref_id,
                    def_id,
                });
