...
//! markdown_it::plugins::extra::footnote::back_refs::add(parser);
...
//! "markdown_it::plugins::extra::footnote::references::FootnoteReference",
//! "markdown_it::plugins::extra::footnote::definitions::FootnoteDefinition",
//! "markdown_it::plugins::cmark::block::paragraph::Paragraph",
//! "markdown_it::parser::inline::builtin::skip_text::Text",
//! "markdown_it::plugins::extra::footnote::back_refs::FootnoteRefAnchor",
//! ]);
//! ```
use crate::{
...
impl NodeValue for FootnoteRefAnchor {
    fn render(&self, _: &Node, fmt: &mut dyn crate::Renderer) {
        for ref_id in self.ref_ids.iter() {
            fmt.text(" ");
            fmt.open(
                "a",
                &[
                    ("href".into(), format!("#fnref{}", ref_id)),
                    ("class".into(), String::from("footnote-backref")),
                ],
            );
